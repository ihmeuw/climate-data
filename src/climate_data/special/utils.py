...
def _to_idx(arr: npt.NDArray[Any], bins: npt.NDArray[Any]) -> npt.NDArray[np.intp]:
...
def compute_person_days(
    ...
    tz_idx: npt.NDArray[Any],
    population: npt.NDArray[Any],
    temp_coords: npt.NDArray[Any],
    out: npt.NDArray[Any],
) -> None:
    ...
    # out has shape num_locations x num_temperature_bins x num_temperature_zones
